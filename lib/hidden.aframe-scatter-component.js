...
function labelMaker (dataEl, graphBoxWidth) {
  ...
  var sepalLength = 'Max compensation : ' + dataValues.SepalLengthCm + '\n \n';
  var petalLength = 'Work again : ' + dataValues.PetalLengthCm + '\n \n';
  var sepalWidth = 'Sepal width : ' + dataValues.SepalWidthCm;
